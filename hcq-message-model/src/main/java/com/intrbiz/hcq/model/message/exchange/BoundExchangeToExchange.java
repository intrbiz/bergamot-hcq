...
@JsonTypeName("hcq.exchange.bound_exchange")
public class BoundExchangeToExchange extends HCQResponse
{
    ...
    public BoundExchangeToExchange()
    {
        super();
    }

    public BoundExchangeToExchange(BindExchangeToExchange request)
    {
        super();
