...
@JsonTypeName("hcq.exchange.bind_queue")
public class BindQueueToExchange extends HCQRequest
{
    ...
    public BindQueueToExchange()
    {
        super();
    }

    public BindQueueToExchange(String exchangeName, String key, String targetName)
    {
        super();
