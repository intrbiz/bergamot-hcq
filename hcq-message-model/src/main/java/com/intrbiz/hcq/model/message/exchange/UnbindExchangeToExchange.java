...
@JsonTypeName("hcq.exchange.unbind_exchange")
public class UnbindExchangeToExchange extends HCQRequest
{
    ...
    public UnbindExchangeToExchange()
    {
        super();
    }

    public UnbindExchangeToExchange(String exchangeName, String key, String targetName)
    {
        super();
